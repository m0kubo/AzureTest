<div class="hosts index">
	...
	<tr>
		...
		<td><?php echo h($host['Host']['title']); ?>&nbsp;</td>
		<td><?php echo h($host['Host']['body']); ?>&nbsp;</td>
		...
		<td class="actions">
			...
			<?php echo $this->Form->postLink(__('Delete'), array('action' => 'delete', $host['Host']['id']), array(), __('Are you sure you want to delete # %s?', $host['Host']['id'])); ?>
		</td>
	</tr>
<?php endforeach; ?>
	</table>
